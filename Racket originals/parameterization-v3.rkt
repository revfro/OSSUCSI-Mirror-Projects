...
;; (X -> Y) (listof X) -> (listof Y) ;; given any function that maps X to Y...
                                     ;; and listof X, produce listof Y
...
(check-expect (map2 string-length (list "prot" "goon" "apps" "hot")) (list 4 4 4 3))
